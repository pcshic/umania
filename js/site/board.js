var UpsBoard = function (data) {
  ...
  var getTitle = function(info, code) {
    return '<header class="panel-heading" role="tab" id="heading-' + code + '"><h2 class="panel-title collapsed" aria-controls="collapse-' + code + '" aria-expanded="false" href="#collapse-' + code + '" data-parent="#versions" data-toggle="collapse"><span class="glyphicon glyphicon-send"></span> ' + info.code + ' (' + info.version + ')<small class="hidden-xs"> ' + info.date + '</small></h2></header>';
  }
