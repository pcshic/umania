var UpsBoard = function (data) {
  ...
  var getTitle = function(info, code) {
    return '<header class="panel-heading" role="tab" id="heading-' + code + '"><h2 class="panel-title collapsed" aria-controls="collapse-' + code + '" aria-expanded="false" href="#collapse-' + code + '" data-parent="#versions" data-toggle="collapse"><span class="glyphicon glyphicon-send"></span> ' + info.code + '<span class="hidden-xs hidden-sm"> (' + info.version + ')</span><small class="hidden-xs hidden-sm"> ' + info.date + '</small></h2></header>';
  }
...
var loadBoard = function() {
  $.get('data/board.yml', '', function (data) {
    ...
    /*                                                       */
    /* ***************************************************** */
    $('#version-info').append(board.getBoard());
    /* ***************************************************** */
    /*                                                       */
    /*  初始化子版本縮放                                     */
    /*                                                       */
